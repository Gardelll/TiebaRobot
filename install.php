...
百度贴吧Cookie[BDUSS]:<input type="text" name="install_bduss" placeholder="BDUSS" /><br />
图灵apikey:<input type="text" name="install_apikey" placeholder="APIKey" /><br />
...
<?php
		...
		break;
	case '2':
		if (empty($_POST['install_bduss']) || empty($_POST['install_apikey'])) break;
